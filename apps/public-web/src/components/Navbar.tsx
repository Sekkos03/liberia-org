    ...
    >
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-4 items-center">
          {links.map((l) => (
            <Link key={l.to} to={l.to} className={linkClasses(pathname === l.to || (l.to === "/contact" && (pathname === "/post" || pathname === "/postbox")))}>
              {l.label}
            </Link>
          ))}
        </nav>
          ...
          {links.map((l) => (
            <Link
              ...
              className={[
                ...
                (pathname === l.to || (l.to === "/contact" && (pathname === "/post" || pathname === "/postbox")))
